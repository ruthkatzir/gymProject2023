...
const Participation = (props) => {
    ...
    return (
        ...
        <ListItemText primary={participation.lessonType} secondary={fullDate}/>   
        {/* <ListItemAvatar> <DisplayRating  stars={participation.grading}></DisplayRating> </ListItemAvatar> */}
       <ListItemAvatar> {props.allowRating==false?  <DisplayRating  stars={participation.grading}></DisplayRating>:<Rate participationId={participation.id}></Rate>} </ListItemAvatar>
      </ListItem>
    )
  }
  export default Participation;